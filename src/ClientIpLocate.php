...
class ClientIpLocate
{
     ...
     * @var string
     */
    protected $url_suggestions = 'rs/iplocate';
     ...
     * @return mixed
     */
    private function query($url, array $params = [], $method = self::METHOD_GET)
    {
        ...
        switch ($response->getStatusCode()) {
            case 200:
                ...
                if (empty($result['location']['value'])) {
     ...
     */
    public function locationByIp($type, $fields)
    {
